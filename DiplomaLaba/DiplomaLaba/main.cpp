...
{	
	...
	Initialization_2_1(W1, W2, W3, t1, t2, t3, Xv, N, Xgr, M);
	...
	double pow1 = 1000;
		...
		double error666 = sqrt((Ev + Egr) / (double(N) + double(M)));
		...
		double error777 = sqrt((Ev + Egr) / (double(N) + double(M)));
		...
		error666 = sqrt((Ev + Egr) / (double(N) + double(M)));
		std::cout << "error666 = " << error666 << std::endl;
		...
		error777 = sqrt((Ev + Egr) / (double(N) + double(M)));
		std::cout << "error777 = " << error777 << std::endl;
